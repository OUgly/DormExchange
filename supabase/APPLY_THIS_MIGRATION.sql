-- Complete Database Migration for DormExchange Listing Images
...
-- Step 5: Create policies for listing_images
...
SELECT 'listing_images table created successfully!' as status;
